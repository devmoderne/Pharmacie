...
// ✅ Récapitulatif par Assurance
export const RecapitulatifAssurance = ({ recapData, dateDebut, dateFin }) => {
    ...
    return (
      <div>
        ...
        <div ref={componentRef} className="a4-print">
          <h3 style={{ textAlign: "center" }}>Récapitulatif des Tickets par Assurance</h3>
